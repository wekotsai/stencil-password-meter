...
let IconBookmark = class {
  constructor(hostRef) {
    registerInstance(this, hostRef);
    this.classes = '';
  }
  render() {
    return (h(Host, { "aria-hidden": "true", role: "presentation" }, h("svg", { class: `icon ${this.classes}`, viewBox: "0 0 24 24", "stroke-linejoin": "round", "stroke-width": "2", stroke: "currentColor" }, h("path", { fill: "none", d: "M19,21 L12,16 L5,21 L5,5 C5,3.8954305 5.8954305,3 7,3 L17,3 C18.1045695,3 19,3.8954305 19,5 L19,21 Z" }))));
  }
};
IconBookmark.style = iconCss;

export { IconBookmark as d4l_icon_bookmark };
