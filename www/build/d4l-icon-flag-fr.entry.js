...
let IconFlagFrance = class {
  constructor(hostRef) {
    registerInstance(this, hostRef);
    this.classes = '';
  }
  render() {
    return (h(Host, { "aria-hidden": "true", role: "presentation" }, h("svg", { xmlns: "http://www.w3.org/2000/svg", class: `icon icon--flag ${this.classes}`, width: "28", height: "20" }, h("defs", null, h("rect", { id: "a", width: "28", height: "20", x: "0", y: "0", rx: "2" })), h("g", { fill: "none", "fill-rule": "evenodd" }, h("mask", { id: "b", fill: "#fff" }, h("use", { xlinkHref: "#a" })), h("rect", { width: "27.5", height: "19.5", x: ".25", y: ".25", stroke: "#F5F5F5", "stroke-width": ".5", rx: "2" }), h("path", { fill: "#F44653", d: "M18.667 0H28v20h-9.333z", mask: "url(#b)" }), h("path", { fill: "#1035BB", d: "M0 0h9.333v20H0z", mask: "url(#b)" })))));
  }
};
IconFlagFrance.style = iconCss;

export { IconFlagFrance as d4l_icon_flag_fr };
