...
let IconFlagGreece = class {
  constructor(hostRef) {
    registerInstance(this, hostRef);
    this.classes = '';
  }
  render() {
    return (h(Host, { "aria-hidden": "true", role: "presentation" }, h("svg", { xmlns: "http://www.w3.org/2000/svg", class: `icon icon--flag ${this.classes}`, width: "28", height: "20" }, h("defs", null, h("rect", { id: "a", width: "28", height: "20", x: "0", y: "0", rx: "2" })), h("g", { fill: "none", "fill-rule": "evenodd" }, h("mask", { id: "b", fill: "#fff" }, h("use", { xlinkHref: "#a" })), h("rect", { width: "27.5", height: "19.5", x: ".25", y: ".25", stroke: "#F5F5F5", "stroke-width": ".5", rx: "2" }), h("path", { fill: "#1C6DC1", d: "M28 16v2.667H0V16h28zM13.333 8v2.667H28v2.666H8V8h5.333zm-8 0v5.333H0V8h5.333zM28 5.333V8H13.333V5.333H28zM5.333 0v5.333H0V0h5.333zM28 0v2.667H13.333v2.666H8V0h20z", mask: "url(#b)" })))));
  }
};
IconFlagGreece.style = iconCss;

export { IconFlagGreece as d4l_icon_flag_gr };
