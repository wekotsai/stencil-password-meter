...
let IconDownload = class {
  constructor(hostRef) {
    registerInstance(this, hostRef);
    this.classes = '';
  }
  render() {
    return (h(Host, { "aria-hidden": "true", role: "presentation" }, h("svg", { class: `icon icon__fill--none ${this.classes}`, focusable: this.focusable, xmlns: "http://www.w3.org/2000/svg", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", viewBox: "0 0 24 24" }, h("path", { d: "M8 17l4 4 4-4M12 12v9" }), h("path", { d: "M20.88 18.09A5 5 0 0018 9h-1.26A8 8 0 103 16.29" }))));
  }
};
IconDownload.style = iconCss;

export { IconDownload as d4l_icon_download };
