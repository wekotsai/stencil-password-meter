...
let IconPlus = class {
  ...
  render() {
    return (h(Host, { "aria-hidden": "true", role: "presentation" }, h("svg", { viewBox: "0 0 24 24", class: `icon ${this.classes}`, focusable: this.focusable, xmlns: "http://www.w3.org/2000/svg", "stroke-linejoin": "round", "stroke-width": "2", stroke: "currentColor" }, h("line", { x1: "12", y1: "4", x2: "12", y2: "20" }), h("line", { x1: "4", y1: "12", x2: "20", y2: "12" }))));
  }
};
IconPlus.style = iconCss;

export { IconPlus as d4l_icon_plus };
