...
let IconKey = class {
  ...
  render() {
    return (h(Host, { "aria-hidden": "true", role: "presentation" }, h("svg", { class: `icon ${this.classes}`, xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 16 16" }, h("path", { d: "M12.67 4.27l-.94-.94L8 7.07 4.27 3.33l-.94.94L7.07 8l-3.74 3.73.94.94L8 8.93l3.73 3.74.94-.94L8.93 8z" }))));
  }
};
IconKey.style = iconCss;

export { IconKey as d4l_icon_close };
