...
let AppForm = class {
  ...
  render() {
    return (h("form", null, h("label", null, h("p", { class: "text" }, "Email"), h("input", { class: "input", type: "email" })), h("label", null, h("p", { class: "text" }, "Password"), h("input", { class: "input", type: this.open ? "password" : "text", value: this.value, onInput: (event) => this.validate(event) }), h("button", { class: "show-hide" }, "\uD83D\uDC41\uFE0F Show password")), this.removeDuplicates(this.list).map(item => (h("ul", { class: "requirements" }, h("li", null, item)))), h("button", { class: "submit", onClick: this.showHandler.bind(this) }, "Submit")));
  }
};
