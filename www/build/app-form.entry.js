...
let AppForm = class {
  ...
  render() {
    return (h("form", null, h("label", null, h("p", { class: "text" }, "Email"), h("input", { class: "input", type: "email" })), h("label", null, h("p", { class: "text" }, "Password"), h("input", { class: "input", type: this.showPassword ? "text" : "password", value: this.value, onInput: (event) => this.validate(event) }), h("button", { class: "show-hide", onClick: this.handleClick.bind(this) }, "\uD83D\uDC41\uFE0F Show password")), this.removeDuplicates(this.list).map(item => (h("ul", { class: "requirements" }, h("li", null, item)))), h("div", { class: "tnc" }, h("input", { type: "checkbox", class: "checkbox", value: this.checkboxValue, onChange: (event) => this.checkboxHandler(event), required: true }), "I accept the ", h("a", { class: "tncLink", href: "#" }, "Terms and Conditions")), h("button", { class: "submit", disabled: !this.disabled }, "Submit")));
  }
};
