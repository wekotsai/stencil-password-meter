...
let IconInfo = class {
  ...
  render() {
    return (h(Host, { "aria-hidden": "true", role: "presentation" }, h("svg", { class: `icon ${this.classes}`, viewBox: "0 0 24 24" }, h("path", { fill: "none", d: "M0 0h24v24H0V0z" }), h("path", { d: "M11 7h2v2h-2zM11 11h2v6h-2z" }), h("path", { d: "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0\n              18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z" }))));
  }
};
IconInfo.style = iconCss;

export { IconInfo as d4l_icon_info };
