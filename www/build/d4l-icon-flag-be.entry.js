...
let IconFlagBelgium = class {
  constructor(hostRef) {
    registerInstance(this, hostRef);
    this.classes = '';
  }
  render() {
    return (h(Host, { "aria-hidden": "true", role: "presentation" }, h("svg", { xmlns: "http://www.w3.org/2000/svg", class: `icon icon--flag ${this.classes}`, width: "28", height: "20" }, h("defs", null, h("rect", { id: "a", width: "28", height: "20", x: "0", y: "0", rx: "2" })), h("g", { fill: "none", "fill-rule": "evenodd" }, h("mask", { id: "b", fill: "#fff" }, h("use", { xlinkHref: "#a" })), h("use", { fill: "#FFF", xlinkHref: "#a" }), h("path", { fill: "#FF4453", d: "M13.333 0H28v20H13.333z", mask: "url(#b)" }), h("path", { fill: "#262626", d: "M0 0h9.333v20H0z", mask: "url(#b)" }), h("path", { fill: "#FFCF3C", d: "M9.333 0h9.333v20H9.333z", mask: "url(#b)" })))));
  }
};
IconFlagBelgium.style = iconCss;

export { IconFlagBelgium as d4l_icon_flag_be };
