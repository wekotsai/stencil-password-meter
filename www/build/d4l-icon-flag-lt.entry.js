...
let IconFlagLithuania = class {
  constructor(hostRef) {
    registerInstance(this, hostRef);
    this.classes = '';
  }
  render() {
    return (h(Host, { "aria-hidden": "true", role: "presentation" }, h("svg", { xmlns: "http://www.w3.org/2000/svg", class: `icon icon--flag ${this.classes}`, width: "28", height: "20" }, h("defs", null, h("rect", { id: "a", width: "28", height: "20", x: "0", y: "0", rx: "2" })), h("g", { fill: "none", "fill-rule": "evenodd" }, h("mask", { id: "b", fill: "#fff" }, h("use", { xlinkHref: "#a" })), h("use", { fill: "#FFF", xlinkHref: "#a" }), h("path", { fill: "#118357", d: "M0 6.667h28v6.667H0z", mask: "url(#b)" }), h("path", { fill: "#D8343D", d: "M0 13.333h28V20H0z", mask: "url(#b)" }), h("path", { fill: "#FEC34B", d: "M0 0h28v6.667H0z", mask: "url(#b)" })))));
  }
};
IconFlagLithuania.style = iconCss;

export { IconFlagLithuania as d4l_icon_flag_lt };
