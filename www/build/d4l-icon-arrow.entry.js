...
let IconArrow = class {
  ...
  render() {
    return (h(Host, { "aria-hidden": "true", role: "presentation" }, h("svg", { class: `icon ${this.classes}`, viewBox: "0 0 24 24", xmlns: "http://www.w3.org/2000/svg", focusable: this.focusable }, h("path", { d: "M14.121 16.566L2.868 5.313.747 7.434 12 18.687l2.121-2.121z" }), h("path", { d: "M9.879 16.566L21.132 5.313l2.121 2.121L12 18.687l-2.121-2.121z" }))));
  }
};
IconArrow.style = iconCss;

export { IconArrow as d4l_icon_arrow };
