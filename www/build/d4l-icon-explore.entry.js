...
let IconExplore = class {
  constructor(hostRef) {
    registerInstance(this, hostRef);
    this.classes = '';
  }
  render() {
    return (h(Host, { "aria-hidden": "true", role: "presentation" }, h("svg", { class: `icon ${this.classes}`, viewBox: "0 0 24 24", xmlns: "http://www.w3.org/2000/svg", stroke: "currentColor", "stroke-width": "2", "stroke-linejoin": "round" }, h("circle", { fill: "none", cx: "12", cy: "12", r: "10" }), h("polygon", { fill: "none", points: "16.24 7.76 14.12 14.12 7.76 16.24 9.88 9.88" }))));
  }
};
IconExplore.style = iconCss;

export { IconExplore as d4l_icon_explore };
