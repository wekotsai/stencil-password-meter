...
let IconFlagFinland = class {
  constructor(hostRef) {
    registerInstance(this, hostRef);
    this.classes = '';
  }
  render() {
    return (h(Host, { "aria-hidden": "true", role: "presentation" }, h("svg", { xmlns: "http://www.w3.org/2000/svg", class: `icon icon--flag ${this.classes}`, width: "28", height: "20" }, h("defs", null, h("rect", { id: "a", width: "28", height: "20", x: "0", y: "0", rx: "2" })), h("g", { fill: "none", "fill-rule": "evenodd" }, h("mask", { id: "b", fill: "#fff" }, h("use", { xlinkHref: "#a" })), h("rect", { width: "27.5", height: "19.5", x: ".25", y: ".25", stroke: "#F5F5F5", "stroke-width": ".5", rx: "2" }), h("path", { fill: "#0848A6", d: "M-1.333 12H8v9.333h4V12h17.333V8H12v-9.333H8V8h-9.333z", mask: "url(#b)" })))));
  }
};
IconFlagFinland.style = iconCss;

export { IconFlagFinland as d4l_icon_flag_fi };
